...
diff --git a//dev/null b/werewolf-GMtool.py
index 0000000000000000000000000000000000000000..c0ce06ebada6c431539b668501486241586abfd2 100644
--- a//dev/null
+++ b/werewolf-GMtool.py
@@ -0,0 +1,208 @@
+#!/usr/bin/env python3
